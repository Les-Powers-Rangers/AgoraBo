    ...
    <div class="container connexion">
        <form class="form-login" method="post" action="index.php?uc=connexion">
            ...
            <div class="login-wrap">
                ...
                document.getElementById('hdMdp').value : la valeur du champ caché
                hdMdp
                document.getElementById('txtMdp').value : la valeur du champ saisi
                txtMdp
                qui est mise à ' ' avant transmission au serveur pour ne
                BTS SIO Lycée Robert Schuman - Metz
                SLAM4 / PPE – Guide mission 3 Agora 1.0 Page 13 / 18
                pas envoyer le mdp en clair
...
e = ' ';">
            ...
            BTS SIO Lycée Robert Schuman - Metz
            SLAM4 / PPE – Guide mission 3 Agora 1.0 Page 12 / 18
